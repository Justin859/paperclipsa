...
<div class="container" align="center">
   ...
   @foreach($camera as $camera)
    <div class="row">
        ...
        <video src="http://41.185.22.138:1935/VOD_STORAGE_2/mp4:{{$camera}}_source.mp4/playlist.m3u8" data-viblast-key="3234ee02-940e-4ee4-8a26-866bc45b4363" controls width="100%" height="auto"></video>
