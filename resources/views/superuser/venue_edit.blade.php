...
<div class="container">
    ...
    <div class="col-12 col-md-9 order-md-2">
        <br />
        <h2 class="pt-2"> Edit: {{$venue->name}} </h2><hr />
        @if ($errors->any())
        ...
        <form action="/user-profile/superuser/venue/save" id="edit-form" method="post" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="name" onkeyup="not_empty(this);" value="{{$venue->name}}" id="venueName" class="form-control" required />
            ...
            <div class="form-group">
                ...
                <textarea name="description" onkeyup="not_empty(this);" id="venueDescription" class="form-control" maxlength="1500" rows="4" required>{{$venue->description}}</textarea>
                <div class="invalid-tooltip">
            ...
            <div class="form-group">
                ...
                <?php $phone_numbers = explode(',', $venue->phone); ?>
                <div id="phone_numbers">
                @foreach($phone_numbers as $key=>$phone_number)
                <div class="input-group mb-3" id="venuePhoneNumberEl_{{$key}}">
                    <input type="tel" onkeyup="valid_phone_number(this);" placeholder="123 456 7890" pattern="[0-9]{3} [0-9]{3} [0-9]{4}" name="phone_number[]" value="{{$phone_number}}" id="venuePhoneNumber_{{$key}}" class="form-control" required />
                    <div class="input-group-append">
                        <button type="button" class="btn btn-outline-danger" type="button" onclick="remove_number({{$key}});" id="button-addon2">Remove</button>
                    </div>
                    <div class="invalid-tooltip">
            ...
            <div class="form-row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" id="venueYoutube" name="intro_vid_url" onkeyup="valid_url(this);" placeholder="ex. https://www.youtube.com/watch?v=qLUZ9-F9tXg" value="{{$venue->intro_vid_url}}" class="form-control">
                    <div class="invalid-tooltip">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" id="venueTwitter" name="twitter_url" onkeyup="valid_url(this);" placeholder="ex. https://twitter.com/paperclipsa" value="{{$venue->twitter_url}}" class="form-control">
                    <div class="invalid-tooltip">
            ...
            <div class="form-row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" id="venueFacebook" name="fb_url" onkeyup="valid_url(this);" placeholder="ex. https://www.facebook.com/paperclipsa" value="{{$venue->fb_url}}" class="form-control">
                    <div class="invalid-tooltip">
                        Please provide a valid url. Ex. https://www.google.co.za
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" id="venueWebsite" name="web_url" onkeyup="valid_url(this);" placeholder="ex. http://www.paperclipsa.co.za/" value="{{$venue->web_url}}" class="form-control">
                    <div class="invalid-tooltip">
                        Please provide a valid url. Ex. https://www.google.co.za
                    </div>
                </div>
            ...
            <div class="form-group">
                <label for="venueBanner">Page Banner (current)</label>
                @if($venue->banner_img)
                    <img src="{{asset('storage/venues/banners/'. $venue->banner_img)}}" class="img-fluid" style="border: 1px solid;" />
                @endif
                    <input type="file" name="banner_img" class="form-control-file" style="color:#ffffff;" id="exampleFormControlFile1">
            </div>
            <div class="form-group">
                <label for="venueLogo">Page Logo (current)</label>
                @if($venue->logo_img)
                    <img src="{{asset('storage/venues/logos/'. $venue->logo_img)}}" height="64" width="64" class="img-fluid" style="border: 1px solid;" />
                @endif
                    <input type="file" name="logo_img" class="form-control-file" style="color:#ffffff;" id="exampleFormControlFile1">
            </div>
            <hr />
            ...
            <div class="form-row">
                ...
                <input type="text" onkeyup="not_empty(this);" class="form-control" name="username" id="username" placeholder="username" value="{{$venue->username}}" required />
                <div class="invalid-tooltip">
                ...
                <input type="text" onkeyup="not_empty(this);" class="form-control" name="password" id="password" placeholder="password" value="{{$venue->password}}" required />
                <div class="invalid-tooltip">
                ...
                <input type="text" onkeyup="not_empty(this);" class="form-control" name="venue_ip" id="ip_address" placeholder="ip address" value="{{$venue->venue_ip}}" required />
                <div class="invalid-tooltip">
            ...
            <div class="form-row">
                ...
                <input type="text" onkeyup="not_empty(this);" class="form-control" name="wow_app_name" id="wow_app_name" placeholder="Wowza Application Name Ex. PAPERCLIP_SA_INDOOR" value="{{$venue->wow_app_name}}" required />
                <div class="invalid-tooltip">
                ...
                <?php
                $field = \App\Field::where('venue_id', $venue->id)->first();
                $port_numbers = explode(',', $field->ports); 
                $port_names = explode(',', $field->port_names);
                ?>
                <label>Area camera port names and port numbers</label>
                <div id="port_numbers">
                @foreach($port_numbers as $key=>$port_number)
                <div class="form-row" style="border: 1px solid;" id="venuePortNameEl_{{$key}}">
                    <div class="form-group col-md-6">
                        <div class="input-group mt-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroupNameAddon_{{$key}}">name</span>
                            </div>
                            <input type="text" onkeyup="not_empty(this);" name="port_name[]" class="form-control" value="{{$port_names[$key]}}" required />
                            <div class="invalid-tooltip">
                    ...
                    <div class="form-group col-md-6">
                        <div class="input-group mt-3" id="venuePortNumberEl_{{$key}}">
                            ...
                            <input type="number" onkeyup="not_empty(this);" placeholder="ex. 555" name="port_number[]" value="{{$port_numbers[$key]}}" id="venuePortNumber_{{$key}}" class="form-control" required />
                            <div class="input-group-append">
...
var add_port = function()
{
    ...
    +                 '<span class="input-group-text" id="inputGroupNameAddon_'+key+'">name</span>'
    +             '</div>'
    +             '<input type="text" onkeyup="not_empty(this);" name="port_name[]" class="form-control" placeholder="ex. Field Z" required />'
    +     '<div class="invalid-tooltip">'
    +      'Please provide a name.'
    +      '</div>'
    +         '</div>'
    ...
    +                 '<span class="input-group-text" id="inputGroupFileAddon01">port</span>'
    +             '</div>'
    +             '<input type="number" onkeyup="not_empty(this);" name="port_number[]" value="555" placeholder="ex. 555" id="venuePortNumber_'+key+'" class="form-control" required />'
    +             '<div class="input-group-append">'
    +                 '<button type="button" class="btn btn-outline-danger" type="button" onclick="remove_port('+key+');" id="button-addon2">Remove</button>'
    +             '</div>'
    +     '<div class="invalid-tooltip">'
