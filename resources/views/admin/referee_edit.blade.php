...
<div class="container">
    <div class="row">
        ...
        <br />
        <h2 style="color:#ffffff;">Edit Referee</h2>
        <hr />
        <form method="post" action="/user-profile/admin/referee-edit" name="update_profile" id="update_profile" class="needs-validation" novalidate>
        {{ csrf_field() }}
        <input type="hidden" name="referee_user_id" value="{{$referee_user->id}}" required/>
        <div class="form-row">
            <div class="col-md-4 mb-3">
            <label for="validationTooltip01">First name</label>
            <input type="text" class="form-control" name="firstname" id="validationTooltip01" placeholder="First name" value="{{$referee_user->firstname}}" required>
            ...
            <input type="text" class="form-control" name="surname" id="validationTooltip02" placeholder="Last name" value="{{$referee_user->surname}}" required>
            <div class="invalid-tooltip">
            ...
            <div class="input-group">
                <input type="email" class="form-control" name="email" id="validationTooltipEmail" value="{{$referee_user->email}}" placeholder="Email address" aria-describedby="validationTooltipEmailPrepend" required>
                <div class="invalid-tooltip">
        ...
        <div class="form-row">
            ...
            <select type="text" class="form-control" name="gender" id="validationTooltip08">
                @if($referee_user->gender == 'none' or $referee_user->gender == 'm')
        ...
        <div class="btn-group float-right" style="margin-bottom: 15px;" role="group" aria-label="form buttons">
            <a href="/user-profile/admin/referees" class="btn btn-outline-danger">Back</a>
